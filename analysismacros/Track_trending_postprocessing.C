...
hfake6.GetYaxis()->SetTitle("Coordinates of the bin with maximum entries");
...
hfake10.GetXaxis()->SetTitle("Runs");
...
hfake11.GetXaxis()->SetTitle("Runs");
...
hfake12.GetXaxis()->SetTitle("Runs");
